...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Jovani_Gislason83',
      password: 'Dux2cTieOsFN6h_',
      email: 'Salvatore.Luettgen83@gmail.com',
      name: 'Mae Barton',
      shippingAddress: [
        {
          _id: false,
          ...
          isDefault: false,
          state: 'generate',
          addressType: 'hierarchy',
          fullName: 'Accountability',
          mobile: 259,
          addressNo: 85
        }
      ],
      ...
      userType: 911,
      mobileNo: '(534) 721-4587',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 270,
      loginReactiveTime: '2024-06-24T01:10:56.830Z',
      id: '655944fefa3eb759f95ecece'
    });
  }
  catch (error) {
    ...
    let registeredUser = await request(app)
      ...
      .send({
        ...
        'shippingAddress':[{
          ...
          'isDefault':false,
          'state':'Fresh',
          'addressType':'overriding',
          'fullName':'Grass-roots',
          'mobile':69,
          'addressNo':539
        }],
        'wishlist':[{
