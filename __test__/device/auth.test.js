...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Jaden_Wuckert',
      password: 'svuDgf4HMfuy0GB',
      email: 'Evie_Tromp@gmail.com',
      name: 'Miss Ronnie Labadie',
      shippingAddress: [
        {
          _id: false,
          pincode: 'azure',
      ...
      userType: 233,
      mobileNo: '(145) 467-1268',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 459,
      loginReactiveTime: '2024-04-27T15:11:15.282Z',
      id: '655944fefa3eb759f95ece62'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Geraldine.Marvin',
        'password':'IWuI0yIBppxV0QC',
        'email':'Fausto_Glover@yahoo.com',
        'name':'Hannah Volkman',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Ariary',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Fausto_Glover@yahoo.com', });
